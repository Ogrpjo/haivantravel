...
export default function EditProjectModal({
  ...
  useEffect(() => {
    if (project && isOpen) {
      setFormData({ link_url: project.link_url ?? "", image: null });
      setErrorMessage("");
    }
  }, [project, isOpen]);
      ...
      >
        ...
        <div className="px-6 py-6">
          <form className="space-y-4" onSubmit={handleSubmit}>
            <div>
              <label htmlFor="edit-project-link" className="block text-sm font-medium text-[#424242] mb-1.5">
                Liên kết dự án
              </label>
              <input
            ...
            <div>
              ...
              >
                Ảnh dự án (để trống nếu giữ nguyên)
              </label>
              <input
